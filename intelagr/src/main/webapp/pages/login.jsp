...
<body>
	<div class="loginC">
		<div class="login">
			<form id="login-form" name = "login-form" method="post" action="user/logindo">
				<ul>
					<li>
...
function onSubmit(){
	Public.ajaxPost("${pageContext.request.contextPath}/user/login",
			//JSON.stringify(login-form.serialize()),
			JSON.stringify($("#login-form").toObject()),
			function(e){
				if(e.status==200){
