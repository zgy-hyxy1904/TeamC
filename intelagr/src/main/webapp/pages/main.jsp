...
<body class="easyui-layout">  
    <div region="north" title="" split="false" class="mainTop">		
  		<a href="../main" style="float:left;color:#000;font-size:30px;font-weight:bold;text-decoration:none;color:#666666;padding-left:10px;">五常优质水稻溯源监管平台</a>		
  		<div style="float:right;font-size:16px;padding-right:10px;">
  			hi,<c:out value="${user.userName}"></c:out> <a href="../user/logout" target="_self" style="text-decoration:none;color:#449942">退出登陆</a>
  		</div>
    </div>
    <div region="west" split="true" title="管理后台" style="width:250px;"> 
    <ul id="menu_tree">   
    <c:forEach items = "${funList }" var = "m">
		<li class="menuTitleLi">
    			<span class="menuTitle">${m.parent.moduleName }</span>
    			<ul>
